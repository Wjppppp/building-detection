...
OUTPUT_DIR = "images/prediction/preview/"
...
#     print("pred_dict", pred_dict)
    ...
    output_dir = "images/prediction/json"
...
#     print("detections",detections)   
    ...
    # image id
    task_id = os.path.splitext(os.path.basename(image_path))[0]
    
    # save prediction image
    output_path = OUTPUT_DIR + task_id +".png"
...
input_dir = "images/prediction/json/"
geojson_all = merge_all_geojson_to_one(input_dir)

output_path = "images/prediction/" + "merged_prediction.geojson"
